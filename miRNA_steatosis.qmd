...
significant_isomiRs_estrict_4cat <- resultsLRT[resultsLRT$padj < 0.05 & abs(resultsLRT$log2FoldChange) > 1, ]  # Estricto

significant_isomiRs_relajado_4cat <- resultsLRT[resultsLRT$padj < 0.1 & abs(resultsLRT$log2FoldChange) > 0.05, ]  # Relajado

significant_isomiRs_masrelajado_4cat <- resultsLRT[resultsLRT$padj < 0.1, ]  # Mas Relajado
